...
describe('Matrix3x3', () => {
  ...
  describe('multiply', () => {
    it('should multiply two matrices', () => {
      ...
      expect(result.values).toEqual([30, 24, 18, 84, 69, 54, 138, 114, 90]);
    });
  ...
  describe('transformations', () => {
    it('should create translation matrix', () => {
      ...
      expect(matrix.values).toEqual([1, 0, 10, 0, 1, 20, 0, 0, 1]);
    });
    ...
    it('should create scale matrix', () => {
      ...
      expect(matrix.values).toEqual([2, 0, 0, 0, 3, 0, 0, 0, 1]);
    });
  });
  ...
  describe('inverse', () => {
    ...
    it('should throw error for non-invertible matrix', () => {
      const matrix = Matrix3x3.create([1, 1, 1, 1, 1, 1, 1, 1, 1]);
  ...
  describe('determinant', () => {
    it('should calculate determinant', () => {
      const matrix = Matrix3x3.create([1, 2, 3, 4, 5, 6, 7, 8, 9]);
      expect(matrix.determinant()).toBe(0);
    });

    it('should calculate non-zero determinant', () => {
      const matrix = Matrix3x3.create([2, 0, 0, 0, 2, 0, 0, 0, 2]);
